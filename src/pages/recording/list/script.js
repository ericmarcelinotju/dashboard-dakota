...
export default defineComponent({
  ...
  setup() {
    ...
    const copyFields = JSON.parse(JSON.stringify(store.getters['fields/recording']))
    ...
    const onConfirmFieldConfig = () => {
      ...
      store.commit('fields/setRecording', fields)
    }
    const setDefaultFields = () => {
      store.commit('fields/setDefaultRecording')
      Object.assign(fields, JSON.parse(JSON.stringify(store.getters['fields/recording'])))
    }
